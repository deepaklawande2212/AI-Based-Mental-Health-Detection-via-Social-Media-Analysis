      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Mental Health Detector</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Advanced AI-powered platform for mental health detection and analysis. 
              Making mental health assessment more accessible and accurate.
            </p>
